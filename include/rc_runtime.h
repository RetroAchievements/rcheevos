...
RC_EXPORT size_t RC_CCONV rc_runtime_progress_size(const rc_runtime_t* runtime, lua_State* L);
RC_EXPORT int RC_CCONV rc_runtime_serialize_progress(const rc_runtime_t* runtime, void* buffer, size_t buffer_size, size_t* serialized_size, lua_State* L);
RC_EXPORT int RC_CCONV rc_runtime_deserialize_progress(rc_runtime_t* runtime, const void* buffer, size_t buffer_size, lua_State* L);
