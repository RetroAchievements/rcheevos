...
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_enable_logging_func_t)(rc_client_t* client, int level, rc_client_message_callback_t callback);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_set_event_handler_func_t)(rc_client_t* client, rc_client_event_handler_t handler);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_set_read_memory_func_t)(rc_client_t* client, rc_client_read_memory_func_t handler);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_set_get_time_millisecs_func_t)(rc_client_t* client, rc_get_time_millisecs_func_t handler);
RC_C_LINKAGE typedef int (RC_CCONV *rc_client_external_can_pause_func_t)(uint32_t* frames_remaining);

RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_set_int_func_t)(int value);
RC_C_LINKAGE typedef int (RC_CCONV *rc_client_external_get_int_func_t)(void);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_set_string_func_t)(const char* value);
RC_C_LINKAGE typedef size_t (RC_CCONV *rc_client_external_copy_string_func_t)(char buffer[], size_t buffer_size);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_action_func_t)(void);

RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_async_handle_func_t)(rc_client_async_handle_t* handle);

RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_login_func_t)(rc_client_t* client,
    const char* username, const char* pass_token, rc_client_callback_t callback, void* callback_userdata);
RC_C_LINKAGE typedef const rc_client_user_t* (RC_CCONV *rc_client_external_get_user_info_func_t)(void);

RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_identify_and_load_game_func_t)(
  rc_client_t* client, uint32_t console_id, const char* file_path,
  const uint8_t* data, size_t data_size, rc_client_callback_t callback, void* callback_userdata);
RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_load_game_func_t)(rc_client_t* client,
  const char* hash, rc_client_callback_t callback, void* callback_userdata);
RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_load_subset_t)(rc_client_t* client,
  uint32_t subset_id, rc_client_callback_t callback, void* callback_userdata);
RC_C_LINKAGE typedef const rc_client_game_t* (RC_CCONV *rc_client_external_get_game_info_func_t)(void);
RC_C_LINKAGE typedef const rc_client_subset_t* (RC_CCONV *rc_client_external_get_subset_info_func_t)(uint32_t subset_id);
RC_C_LINKAGE typedef void (RC_CCONV *rc_client_external_get_user_game_summary_func_t)(rc_client_user_game_summary_t* summary);
RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_change_media_func_t)(rc_client_t* client, const char* file_path,
  const uint8_t* data, size_t data_size, rc_client_callback_t callback, void* callback_userdata);
...
RC_C_LINKAGE typedef struct rc_client_achievement_list_info_t* (RC_CCONV *rc_client_external_create_achievement_list_func_t)(int category, int grouping);
RC_C_LINKAGE typedef const rc_client_achievement_t* (RC_CCONV *rc_client_external_get_achievement_info_func_t)(uint32_t id);
...
RC_C_LINKAGE typedef struct rc_client_leaderboard_list_info_t* (RC_CCONV *rc_client_external_create_leaderboard_list_func_t)(int grouping);
RC_C_LINKAGE typedef const rc_client_leaderboard_t* (RC_CCONV *rc_client_external_get_leaderboard_info_func_t)(uint32_t id);
...
RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_fetch_leaderboard_entries_func_t)(rc_client_t* client,
...
RC_C_LINKAGE typedef rc_client_async_handle_t* (RC_CCONV *rc_client_external_begin_fetch_leaderboard_entries_around_user_func_t)(rc_client_t* client,
  uint32_t leaderboard_id, uint32_t count, rc_client_fetch_leaderboard_entries_callback_t callback, void* callback_userdata);


RC_C_LINKAGE typedef size_t (RC_CCONV *rc_client_external_progress_size_func_t)(void);
RC_C_LINKAGE typedef int (RC_CCONV *rc_client_external_serialize_progress_func_t)(uint8_t* buffer);
RC_C_LINKAGE typedef int (RC_CCONV *rc_client_external_deserialize_progress_func_t)(const uint8_t* buffer);
